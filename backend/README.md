...
## Project Structure
    ...
    ├── sales_atomizer_app_37222  # Django project configurations
...
1. Clone this repo and `cd sales_atomizer_app_37222`
...
2. Clone this repo and `cd sales_atomizer_app_37222`
